...
import { TypingZen } from "@/components/lab/TypingZen";
import Link from "next/link";
import { FaArrowLeft } from "react-icons/fa";

export default function TypingZenPage() {
    return (
        <div className="w-full min-h-screen relative bg-[#0f172a]">
            {/* Navigation Overlay */}
            <div className="absolute top-0 left-0 w-full z-50 p-6 flex justify-between items-center pointer-events-none">
                ...
                <div className="pointer-events-auto bg-white/5 backdrop-blur-md px-6 py-2 rounded-full border border-white/10">
                    <h1 className="text-white font-bold tracking-wider text-sm uppercase">Experiment 06</h1>
                </div>
            </div>
