...
import { QuantumField } from "@/components/lab/QuantumField";
        ...
        <div className="w-full min-h-screen relative bg-black overflow-hidden intro-fade-in">
            ...
            <div className="absolute top-0 left-0 w-full z-50 p-6 flex justify-between items-center pointer-events-none">
                ...
                <div className="pointer-events-auto bg-white/5 backdrop-blur-md px-6 py-2 rounded-full border border-white/10">
                    <h1 className="text-white font-bold tracking-wider text-sm uppercase">Experiment 07: Quantum Field</h1>
                </div>
            </div>
            ...
            <div className="absolute bottom-10 left-0 w-full text-center pointer-events-none z-50">
                <p className="text-white/30 text-sm font-thin tracking-widest uppercase">Move Cursor to Disturb Field</p>
            </div>
        </div>
    );
}
